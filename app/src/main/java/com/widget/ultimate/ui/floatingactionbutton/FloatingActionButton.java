...
public class FloatingActionButton extends ImageButton {
    ...
    void updateBackground() {
        ...
        LayerDrawable layerDrawable = new LayerDrawable(
                new Drawable[]{
                        getResources().getDrawable(mSize == SIZE_NORMAL ? R.drawable.base_ultimate_floating_action_button_fab_bg_normal : R.drawable.base_ultimate_floating_action_button_fab_bg_mini),
