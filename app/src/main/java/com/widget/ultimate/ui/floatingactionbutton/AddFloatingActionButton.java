...
public class AddFloatingActionButton extends FloatingActionButton {
  ...
  Drawable getIconDrawable() {
    final float iconSize = getDimension(R.dimen.base_ultimate_fab_icon_size);
    final float iconHalfSize = iconSize / 2f;

    final float plusSize = getDimension(R.dimen.base_ultimate_fab_plus_icon_size);
    final float plusHalfStroke = getDimension(R.dimen.base_ultimate_fab_plus_icon_stroke) / 2f;
