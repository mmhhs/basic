 ...
 */
public class ProgressWheel5 extends View {
    private static final String TAG = ProgressWheel5.class.getSimpleName();
     ...
     * @param attrs
     */
    public ProgressWheel5(Context context, AttributeSet attrs) {
        super(context, attrs);

        parseAttributes(context.obtainStyledAttributes(attrs,
                R.styleable.ProgressWheel5));
    }
     ...
     * @param context
     */
    public ProgressWheel5(Context context) {
        super(context);
    }
    ...
    private void parseAttributes(TypedArray a) {
        ...
        circleRadius = (int) a.getDimension(R.styleable.ProgressWheel5_matProg_circleRadius, circleRadius);

        fillRadius = a.getBoolean(R.styleable.ProgressWheel5_matProg_fillRadius, false);

        barWidth = (int) a.getDimension(R.styleable.ProgressWheel5_matProg_barWidth, barWidth);

        rimWidth = (int) a.getDimension(R.styleable.ProgressWheel5_matProg_rimWidth, rimWidth);

        float baseSpinSpeed = a.getFloat(R.styleable.ProgressWheel5_matProg_spinSpeed, spinSpeed / 360.0f);
        spinSpeed = baseSpinSpeed * 360;

        barSpinCycleTime = a.getInt(R.styleable.ProgressWheel5_matProg_barSpinCycleTime, (int) barSpinCycleTime);

        barColor = a.getColor(R.styleable.ProgressWheel5_matProg_barColor, barColor);

        rimColor = a.getColor(R.styleable.ProgressWheel5_matProg_rimColor, rimColor);

        linearProgress = a.getBoolean(R.styleable.ProgressWheel5_matProg_linearProgress, false);

        if (a.getBoolean(R.styleable.ProgressWheel5_matProg_progressIndeterminate, false)) {
            spin();
        }
