package com.feima.baseproject.view.pickerview.popwindow;
...
import com.feima.baseproject.view.pickerview.LoopListener;
import com.feima.baseproject.view.pickerview.LoopView;
...
//                    initHourPickerView();
    ...
    private void initHourPickerView() {
        ...
        for (int i = 8; i <= 17; i++) {
            hourList.add(format2LenStr(i)+mContext.getString(R.string.hour));
        }
    ...
    public void onClick(View v) {
        ...
        if (v == contentView || v == cancelBtn) {
            ...
            if (null != mListener) {
                ...
                if (showHour){
                    mListener.onDatePickCompleted(year, month, day,hour.replace(mContext.getString(R.string.hour),""), sb.toString());
                }
            }
