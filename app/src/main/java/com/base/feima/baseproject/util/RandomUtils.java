...
public class RandomUtils {
     ...
     * @param length
     * @return
     * @see com.base.feima.baseproject.util.RandomUtils#getRandom(String source, int length)
     */
     ...
     *         <li>else see {@link com.base.feima.baseproject.util.RandomUtils#getRandom(char[] sourceChar, int length)}</li>
     *         </ul>
     */
