...
package com.base.feima.baseproject.image.instrumentation;
...
/**
 * {@link com.android.volley.toolbox.NetworkImageView} that notifies its instance of {@link Instrumentation} whenever an image
...
public class InstrumentedNetworkImageView extends NetworkImageView implements Instrumented {
  ...
  public void setImageResource(int resourceId) {
    if (resourceId == R.color.grey) {
      // ignore
    } else if (resourceId == R.color.red) {
