...
public abstract class BaseTask<Params, Progress, Result> {
    ...
    public static void cancelTasks(){
    	while(taskList.size()>0){
    		BaseTask task = taskList.remove(0);
    		task.cancel(true);
    	}
    }
            ...
            protected void done() {
                ...
                try {
                    ...
                    message = sHandler.obtainMessage(MESSAGE_POST_CANCEL,
                            new UserTaskResult<Result>(BaseTask.this, (Result[]) null));
                ...
                message = sHandler.obtainMessage(MESSAGE_POST_RESULT,
                        new UserTaskResult<Result>(BaseTask.this, result));
                message.sendToTarget();
            }
        };
    }
     ...
     *         {@link BaseTask.Status#RUNNING} or {@link BaseTask.Status#FINISHED}.
     */
...
//                	Log.i("Jason","UserTask-handleMessage-result.mData[0]="+result.mData[0]);
    ...
    private static class UserTaskResult<Data> {
        ...
        UserTaskResult(BaseTask task, Data... data) {
            mTask = task;
            mData = data;
        }
    }
